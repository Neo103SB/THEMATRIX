...
VTIGER_ENPOINT = 'http://tmp.ineos-crm.ma/vtigercrm/webservice.php'
VTIGER_USERNAME = 'ecole-centrale'
VTIGER_ACCESSKEY = '<RNbpqegB1SYW6VX>'

INEOS_ZAMEL = vtiger.VTigerAdmin(VTIGER_ENPOINT,VTIGER_USERNAME, VTIGER_ACCESSKEY)
INEOS_ZAMEL.list_types()
